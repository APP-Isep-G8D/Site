...
<div id="carte">
    ...
    <h1>Liste des centres de la Porvence-Alpes-Côtes-D'Azur:</h1>
<?php   
    $medecin = $bdd->query('SELECT * FROM centremedical WHERE region ="Porvence-Alpes-Côtes-Dazur"');
if(empty($medecin)==FALSE){
