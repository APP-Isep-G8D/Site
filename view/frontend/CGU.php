...
<div id="contenuCGU">
	...
	<p>
		<div id="CGU">
			...
			<br>
			Les techniques et prises de mesures sont réalisées par des professionnels surentrainés. En conséquence, il ne faut pas tenter de reproduire ou d'imiter le contenue de ce projet. Ne faites pas ça chez vous.
			<br>
