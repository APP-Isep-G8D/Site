  ...
  <div id="centre" style="background-color:#F5F5F5;">
    ...
    <div id="tonalité" style="background-color:#8FC5FF;">
      ...
      <div class="description_produit"> <br>
        ...
        <img src="tonalite.png" class="image_texte" alt="image_capteur" title="Capteurator" style="width: 269px; height: 263px;">
      </div>
    </div>
    <div id="température">
      <div id="titre"> Capteur de température </div>
      <div class="description_produit"> <br>
        <img src="temperature.png" class="image_texte" alt="image_capteur" title="Capteurator" style="width: 269px; height: 263px;">
    ...
    <div id="cardiaque" style="background-color:#8FC5FF;">
      ...
      <div class="description_produit"> <br>
        ...
        <img src="frequencecardiaque.png" class="image_texte" alt="image_capteur" title="Capteurator" style="width: 269px; height: 263px;">
      </div>
    </div>
    <div id="reactivite">
      <div id="titre"> Mesure de la réactivité </div>
      <div class="description_produit"> <br>
        <img src="reactivite.png" class="image_texte" alt="image_capteur" title="Capteurator" style="width: 269px; height: 263px;">
        <p class="texte_image" style="text-align: right;">
          <font size="+3">
