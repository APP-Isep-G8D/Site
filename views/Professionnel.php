    ...
    <div id="centre" style="background-color:#F5F5F5;">
      <div id="généralité">
        ...
        <div class="description_produit"> <br>
          <img src="capteur.jpeg" class="image_texte_capteur" alt="image_capteur"
            title="Capteurator"
            style="width: 352px; height: 335px; ">
          <dl class="texte_image" style="text-align: right;">
            <dd> <font size="+3"> Une&nbsp;carte&nbsp;mère <b>surpuissante</b>
      ...
      <div id="tonalité" style="background-color:#8FC5FF;">
        ...
        <div class="description_produit"> <br>
          <p class="texte_image" style="color: white; text-align: left;"> <font
              size="+3">
              <span style="color: #f3f3f3;"> Des années de recherches pour
                ...
                Hertz </span></font> </p>
          <img src="tonalite.png" class="image_texte" alt="image_capteur" title="Capteurator"
            style="width: 269px; height: 263px;">
        </div>
      </div>
      <div id="température">
        <div id="titre"> Capteur de température </div>
        <div class="description_produit"> <br>
          <img src="temperature.png" class="image_texte" alt="image_capteur" title="Capteurator"
            style="width: 269px; height: 263px;">
          <p class="texte_image" style="text-align: right;"> <font size="+3">
        ...
        <div class="description_produit"> <br>
          <p class="texte_image" style="color: white; text-align: left;"> <font
              ...
              <span style="color: #f3f3f3;"> Une façon <b>innovante</b> de
                ...
                au service de tous.</span></font> </p>
          <img src="frequencecardiaque.png" class="image_texte" alt="image_capteur"
            title="Capteurator"
            style="width: 269px; height: 263px;">
        </div>
      </div>
      <div id="reactivite">
        ...
        <div class="description_produit"> <br>
          <img src="reactivite.png" class="image_texte" alt="image_capteur" title="Capteurator"
            style="width: 269px; height: 263px;">
          <p class="texte_image" style="text-align: right;"> <font size="+3">
