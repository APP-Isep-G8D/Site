		...
		<div id="conteneurCentreC">
            ...
            <div id="SepConteneurCentre">
                <div id="infoCentreBoitier">
                    <?php echo "<p>Liste des boitiers utilisés :<br><br><br> </p>";
                    $boitierQ = $bdd->query("SELECT * FROM boitier WHERE idCentre=$id");
                    while($boitier=$boitierQ->fetch_array() ){
                        $idboitier = $boitier["idBoitier"];
                        ?>
                        <a href="verifDelBoitier.php?idB=<?php echo $idboitier;?>"style="font-size:16px;text-decoration:none;color:black;font-weight:bold" ><?php echo "Id boitier: #", $boitier["idBoitier"], "<br>"?></a>
                        <?php
                        }
                        ?>
                        <br>
                ...
                <div id="infoCentreMedecins">
                    ...
                    while($row=$donnee->fetch_array() ){
                        ...
                        ?><a href="verifDelMedecin.php?id=<?php echo $medecin["idUtilisateur"];?>" style="font-size:16px;text-decoration:none;color:black;font-weight:bold" ><?php echo "- ", $medecin["prenom"], " ", $medecin["nom"],",  ", $medecin["mail"];?></a>
                        <br><br><?php
                    }
                    ?>
                    </p>
