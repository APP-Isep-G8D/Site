...
$newReq = $bdd->prepare("SELECT * FROM medecin WHERE idUtilisateur = ?");
...
<body>	
	...
	<p>
		<a href="testsPatients.html" id="erreure_bouton">Accèder aux patients</a>
	</p>	
</body>
