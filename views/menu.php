...
<header>
	<a href="main.php" class="headerlogo"><img id="logo" class="erreur_image" src="im.gif"></a>
	...
	<a class="header2" href="PageErreur.html"><img id="loupe" class="search"  src="camionSAV.png"></a>
	<a class="header3" href="login.php"><?php echo $loginMsg; ?></a>
	<a class="headerlogo" href="logout.php"><?php echo $profilconnecte; ?></a>
</header>
